...
public class Pinyin {
	...
	public static List<String> pinyinForMultiple(String str) {
		return PinyinUtil.INSTANCE.convertForMultiple(str, PinyinFormatter.TYPE.WITHOUT_NUM_PINYIN_FORMAT);
	}
